    ...
    <div className="min-h-screen bg-luxury-cream pb-32">
               ...
               <div key={cat} className="space-y-4">
                  ...
                  <div className="bg-white rounded-[48px] shadow-xl overflow-hidden border border-luxury-gold/5">
                     {(items as any[]).map((ing, i) => {
                        ...
                        return (
                           <div key={i} onClick={() => setCheckedItems(prev => isChecked ? prev.filter(item => item !== ing.name) : [...prev, ing.name])} className={cn("flex justify-between items-center p-7 border-b border-luxury-cream last:border-0 hover:bg-luxury-cream/10 transition-all group cursor-pointer", isChecked ? "bg-luxury-cream/40 opacity-50" : "")}>
                              <div className="flex items-center gap-5">
                                 <div className={cn("w-7 h-7 border-2 border-luxury-gold/20 rounded-xl group-hover:border-luxury-gold transition-all flex items-center justify-center", isChecked && "bg-luxury-gold border-luxury-gold")}>
                                    {isChecked && <CheckCircle2 size={16} className="text-white" />}
                                 </div>
                                 <span className={cn("font-bold text-luxury-charcoal text-lg", isChecked && "line-through")}>{ing.name}</span>
                              </div>
      ...
      {isAILoading && (
        <div className="fixed inset-0 z-[250] bg-luxury-charcoal/98 backdrop-blur-3xl flex flex-col items-center justify-center text-white space-y-12">
           <div className="relative"><Camera size={100} className="text-luxury-gold relative z-10" /><Loader2 size={130} className="absolute -top-3.5 -left-2.5 text-luxury-gold animate-spin opacity-40" /></div>
